...
// Tipo auxiliar para mapear el tipo_id que viene del backend
type VehiculoSinTipo = Omit<Vehiculo, 'tipo'> & { tipo_id: number }
    ...
    async function fetchData() {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          const vehiculosTransformados: Vehiculo[] = data.map(
            (vehiculo: VehiculoSinTipo): Vehiculo => ({
              ...vehiculo,
              ...
              <tr key={vehiculo.placa} className="border-b hover:bg-gray-50">
                ...
                <td className="p-3 flex gap-2">
                  <button
                    ...
                    title="Editar"
                    onClick={() => setEditableVehiculo(vehiculo)}
                  >
                    <FaEdit />
                  </button>
                  <button
